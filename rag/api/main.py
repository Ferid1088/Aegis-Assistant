...
from rag.api.routers import (
    admin_audit, admin_observability, admin_rbac, admin_sources, admin_users, auth as auth_router, conversations,
    documents, search,
)
...
def create_app() -> FastAPI:
    ...
    app.include_router(admin_observability.router, prefix="/api/v1/admin", tags=["admin"])
