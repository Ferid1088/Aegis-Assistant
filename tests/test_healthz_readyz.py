...
def test_readyz_returns_200_when_postgres_healthy(mock_check_postgres, client):
...
@patch("rag.api.main.check_postgres")
def test_readyz_returns_503_when_postgres_unhealthy(mock_check_postgres, client):
